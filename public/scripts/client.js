...
const createTweetElement = function (tweet) {
  ...
  const userCheck = () => {
    if (tweet.user.handle === "@fullStack"){
      tweetContent = "check out my <a href=//www.linkedin.com/in/joshua-lerner95> LinkedIn page! </a>"
    } else {
      tweetContent = escape(tweet.content.text)
    }
    return tweetContent
  }
   ...
   const $tweet = `
    <article class="tweet-container">
      ...
      <section class="tweet">${userCheck()}</section>
      <footer>
